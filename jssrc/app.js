...
jQuery.ajax({url: "CurrentUser"}).done(function(oUser){
    jQuery("body").prepend('<a href="#" id="logout" style="float:right;padding-right:1em">logout</a>');
    jQuery("#logout").click(function(){
       jQuery.ajax({url: "logout", type:'DELETE'}).done(function(oUser){
           location.reload();
       });
    });
    ...
    requirejs(["//rhildred.github.io/editable/jssrc/lib/jquery.editor"], function(){
